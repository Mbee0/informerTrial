...
parser.add_argument('--data_path', type=str, default='semi_big_fire_data.csv', help='data file')    
...
data_parser = {
    ...
    'custom':{'data':'semi_big_fire_data.csv','T':'min_lon','M':[6,6,6],'S':[1,1,1],'MS':[6,6,1]},
}
